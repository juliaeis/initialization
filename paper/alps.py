...
if __name__ == '__main__':
    ...
    cfg.PATHS['plot_dir'] = os.path.join(cfg.PATHS['working_dir'], 'plots','paper')
    ...
    for gdir in gdirs:
        ...
        try:
            ...
            if ex_mod.area_km2_ts()[2000] > 0.01:
                ...
                #plot_fitness_values(gdir, df, ex_mod, 1850, cfg.PATHS['plot_dir'])
                #plot_median(gdir, df, 125, ex_mod, 1850, 2000, cfg.PATHS['plot_dir'])
